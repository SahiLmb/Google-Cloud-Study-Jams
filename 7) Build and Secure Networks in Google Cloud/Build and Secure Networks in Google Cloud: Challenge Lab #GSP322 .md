...
- Copy your SSH_IAP_NETWORK_tag from your assigned lab.
```cmd
SSH_IAP_Network_tag=
```
Copy your SSH_Internal_Network_tag from your assigned lab.
```cmd
SSH_Internal_Network_tag=
```
Copy your HTTP_Network_Tag from your assigned lab.
```cmd
HTTP_Network_Tag=
```
